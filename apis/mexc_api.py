...
class mexc_api:
	...
	def __init__(self, api_keys):
		self.api_keys = {'api_key':api_keys['mexc_keys']['api_key'],'secret_key':api_keys['mexc_keys']['secret_key']}
		self.exchange = ccxt.mexc({'apiKey':self.api_keys['api_key'], 'secret':self.api_keys['secret_key']})
		self.markets = {}
		self.get_markets()
